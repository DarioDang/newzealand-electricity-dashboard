...
COMMENT ON COLUMN grid_zones.grid_zone_id   IS 'Numeric zone ID as returned by em6 API.';
COMMENT ON COLUMN grid_zones.grid_zone_name IS 'Human readable zone name e.g. Auckland, Canterbury.';
COMMENT ON COLUMN grid_zones.island         IS 'NI = North Island, SI = South Island.';
